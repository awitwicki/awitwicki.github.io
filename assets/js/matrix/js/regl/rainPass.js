...
export default ({ regl, config, lkg }) => {
	...
	const rainPassIntro = loadText("assets/js/matrix/shaders/glsl/rainPass.intro.frag.glsl");
	const introUniforms = {
		...commonUniforms,
	...
	const rainPassRaindrop = loadText("assets/js/matrix/shaders/glsl/rainPass.raindrop.frag.glsl");
	...
	const rainPassSymbol = loadText("assets/js/matrix/shaders/glsl/rainPass.symbol.frag.glsl");
	...
	const rainPassEffect = loadText("assets/js/matrix/shaders/glsl/rainPass.effect.frag.glsl");
	...
	const rainPassVert = loadText("assets/js/matrix/shaders/glsl/rainPass.vert.glsl");
	const rainPassFrag = loadText("assets/js/matrix/shaders/glsl/rainPass.frag.glsl");
